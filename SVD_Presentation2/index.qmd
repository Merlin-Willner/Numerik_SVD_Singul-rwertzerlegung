...
::: {.dimension-example}
$$
\Sigma=\begin{pmatrix}3&0\\0&2\end{pmatrix}\binom{1}{1}=\binom{3}{2}
\qquad\Longrightarrow\qquad
\begin{pmatrix}3&0\\0&{\color{#ff3b35}0}\end{pmatrix}\binom{1}{1}=\binom{3}{{\color{#ff3b35}0}}
$$

Die Diagonale von $\Sigma$ enthält die **Singulärwerte** $\sigma_1=3,\ \sigma_2=2$. Den kleinsten auf ${\color{#ff3b35}0}$ setzen entfernt eine Richtung — jeder Punkt landet auf der Linie $y=0$.
:::
...
Sie bestimmen, wie stark jede Richtung gewichtet wird. Der **kleinste Singulärwert** $=0$ entfernt die unwichtigste Richtung — aus einer Fläche wird eine Linie.
...
${\color{#1e88ff}{u_i}}$ — Spalten von $U$ · ${\color{#f2aa00}{\sigma_i}}$ — Singulärwerte in $\Sigma$ · ${\color{#ff3b35}{v_i^T}}$ — Zeilen von $V^T$

Jeder Block ${\color{#f2aa00}{\sigma_i}}{\color{#1e88ff}{u_i}}{\color{#ff3b35}{v_i^T}}$ unten ist eine **Rang-1-Matrix**; aufsummiert ergeben sie genau die Produktform oben.
:::
