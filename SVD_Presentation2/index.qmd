...
::: {.uebergang}
**Können wir aus \(A\) eine symmetrische Matrix bauen, die dieselbe Bewertungsfrage für Spaltenmuster beantwortet?**
:::
...
::: {.uebergang}
**Merke: $A{\color{#16a34a}{v_i}}$ enthält Höhenform und Singulärwert-Skalierung. Durch ${\color{#1e88ff}{u_i}}=\frac{A{\color{#16a34a}{v_i}}}{\sigma_i}$ erhalten wir die normierte Höhenverteilung.**
:::
