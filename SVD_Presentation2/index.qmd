...
::: {.derivation-fullnote}
Die Höhenantwort $A{\color{#16a34a}{v}}$ zeigt, wie stark das Spaltenmuster in jeder Bildzeile vorkommt. Ihre Länge misst die Gesamtstärke: $\|A{\color{#16a34a}{v}}\|=(2^2+2^2+2^2+2^2+0^2+0^2)^{1/2}=4$.
